...
class DesignerController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['viewafterupdate', 'id' => $model->designer_user_name,'checkIfUpdate'=>'created']);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['viewafterupdate', 'id' => $model->designer_user_name,'checkIfUpdate'=>'updated']);
        } else {
