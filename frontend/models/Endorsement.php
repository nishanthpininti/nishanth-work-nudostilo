 ...
 * @property integer $sense_of_fasion
...
class Endorsement extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['sense_of_fasion', 'sense_of_style', 'decisiveness', 'creativity', 'collaboration', 'sense_of_style_counter', 'sense_of_fashion_counter', 'sense_of_decisiveness_counter', 'sense_of_creativity_counter', 'sense_of_collaboration_counter'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'sense_of_fasion' => 'Sense Of Fashion',
	...
	{
		$endorsement = Endorsement::findBySql('select sense_of_fasion, sense_of_style, decisiveness, creativity from endorsement where user_name ="'.$username.'"')->one();
		return $endorsement;
	}
}
