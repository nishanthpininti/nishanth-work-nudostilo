 ...
 */
class InvestorSocialLogin extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
	...
	public function getInvestorInfo($username)
	{
		$name = InvestorSocialLogin::findBySql('select investor_first_name, investor_last_name from investor where investor_user_name ="'.$username.'"')->one();
		 return $name;
	}
}
