...
class Designer extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['designer_id', 'designer_user_name', 'designer_first_name', 'designer_last_name', 'designer_email', 'designer_gender'], 'required'],
            [['designer_birthdate'], 'safe'],
            [['designer_id', 'designer_user_name', 'designer_email'], 'string', 'max' => 45],
