...
<div id="lightbox" style="position:absolute; width:100%">
	...
	<h5 style="color: #000000">Collaboration - <?= $endorsement->collaboration ?></h5>
	</div>
	<div class="col-xs-3">
	<?php 
	...
	<div class="col-xs-1">
	<p><?= Html::button('Cancel',['class'=>'btn btn-primary','id'=>'cancelpostbutton']) ?></p>
	</div>
	<div class="col-xs-2">
	...
	<div class="row row-list">
	<div class="col-xs-3">
		<p><a class="btn btn-default" href="index.php?r=profile/default/viewmyfriend&username=<?= $session['user_name'] ?>" id="friendlist">My Friends &raquo;</a></p>
	</div>
	<div class="col-xs-3">
		<p><a class="btn btn-default" href="#" id="mystyles">My Styles &raquo;</a></p>
	</div>
	<div class="col-xs-3">
		<p><a class="btn btn-default" href="#" id="mystyles">My Favourite Styles &raquo;</a></p>
	</div>
	</div>
</div>
