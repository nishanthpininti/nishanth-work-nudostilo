...
<div id="lightbox" style="position:absolute; width:100%">
	...
	<br/>
	<p><a class="btn btn-default" href="index.php?r=profile/default/viewdesigners&username=<?= $session['user_name'] ?>" id="designerlist">View Designers &raquo;</a></p>
</div>
...
<?php $form = ActiveForm::begin(['id' => 'updatebasicprofinfoform', 'method' => 'post', 'action' => Url::to(['default/updateinvestorbasicprofinfo']),
